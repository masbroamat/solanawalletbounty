...
export default function Login() {
  ...
  return (
    <div
      className="relative flex h-screen w-screen justify-end items-center bg-cover bg-center bg-no-repeat"
      style={{
    ...
    >
      ...
      <motion.div
        className="z-7 formdivsignup w-[400px] overflow-hidden rounded-xl border border-white/20 bg-black/20 backdrop-blur-md"
      ...
      >
        ...
        <form className="px-8 py-6">
          ...
          >
            ...
            <Link
              href="/signin"
              className="font-medium text-[#8043e0] hover:text-[#6c37bd] transition-colors duration-200"
            >
              Sign in
            </Link>
            {" here."}
      ...
      {showSignUpMessage && (
        <div className="signout-message">
          <p>Successful sign up. Redirecting to sign in page...</p>
        </div>
      )}
    </div>
  );
